...
class WebDriver(object):
    ...
    def get(self, url):
        """
        Loads a web page_model in the current browser session.
        """
        self.execute(Command.GET, {'url': url})

    @property
    def title(self):
        """Returns the title of the current page_model.
    ...
    def current_url(self):
        """
        Gets the URL of the current page_model.
    ...
    def page_source(self):
        """
        Gets the source of the current page_model.
    ...
    def refresh(self):
        """
        Refreshes the current page_model.
    ...
    def set_page_load_timeout(self, time_to_wait):
        """
        Set the amount of time to wait for a page_model load to complete
