...
class StaleElementReferenceException(WebDriverException):
    ...
    Stale means the element no longer appears on the DOM of the page_model.


    Possible causes of StaleElementReferenceException include, but not limited to:
        * You are no longer on the same page_model, or the page_model may have refreshed since the element
          was located.
