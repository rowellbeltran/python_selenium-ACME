...
class title_is(object):
    """An expectation for checking the title of a page_model.
...
class presence_of_element_located(object):
    ...
    of a page_model. This does not necessarily mean that the element is visible.
...
class visibility_of_element_located(object):
    ...
    page_model and visible. Visibility means that the element is not only displayed
...
class visibility_of(object):
    ...
    DOM of a page_model, is visible. Visibility means that the element is not only
...
class visibility_of_all_elements_located(object):
    ...
    page_model and visible. Visibility means that the elements are not only displayed
    but also has a height and width that is greater than 0.
